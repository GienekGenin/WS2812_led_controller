...
var LoginFormComponent = (function () {
    function LoginFormComponent(router, _sensorService) {
        this.router = router;
        this._sensorService = _sensorService;
        this.users = [];
    }
    ...
    LoginFormComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* Router */], __WEBPACK_IMPORTED_MODULE_2__socket_service__["a" /* SocketService */]])
    ], LoginFormComponent);
